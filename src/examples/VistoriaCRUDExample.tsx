...
import { z } from 'zod';
// Ajuste o caminho abaixo para o local correto do arquivo supabase types
...
// Tipo para uma linha da tabela 'vistorias' do Supabase
type Vistoria = Database['public']['Tables']['vistorias']['Row'];
